...
fn compute_single_pawn_attacking_moves(pos: &Position, id: i8) -> BitB64 {
...
pub fn compute_pawn_attacking_moves(pos: &Position) -> BitB64 {
    let mut result = EMPTY_BOARD;
    let mut piece_set = pos.pieces_to_move().pawns;
    while piece_set != 0 {
        let id = piece_set.trailing_zeros() as u8;
        result |= compute_single_pawn_attacking_moves(pos, id as i8);
...
impl BitboardMoveGenerator for PawnBitboardMoveGenerator {
    fn get_attacking_moves(pos: &Position) -> MovesMap {
        ...
        while pawn_set != EMPTY_BOARD {
            ...
            let resulting_moves = internal::bitb64_to_moves_list(
                id as u8,
                compute_single_pawn_attacking_moves(pos, id),
            );
    ...
    fn generate_moves(pos: &Position) -> MovesMap {
        ...
        while pawn_set != EMPTY_BOARD {
            ...
            // Last, also the captures.
            cur_pawn_moves |= compute_single_pawn_attacking_moves(pos, id);
