...
use crate::bitboard::player::PlayerColor;
use crate::bitboard::chess::{BitboardMove};

fn rook_moves(from_square: usize) -> u64 {
    let mut moves = 0u64;
...
pub fn generate_rook_moves(board: &Position, color: PlayerColor) -> BitboardMove {
